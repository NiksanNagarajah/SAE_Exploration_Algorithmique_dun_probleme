...
def eloignement_max(G:nx.Graph):
    """
    La fonction permet de determiner la distance maximum dans G entre
    toute paire d’acteurs/actrices.

    Args:
        G (Graph): Le graphe représentant considéré.

    Returns:
        ensemble_final (set) : ensemble de tuples d'acteurs qui ont la disatnce maximale.
    """
    ensemble_final = set()
